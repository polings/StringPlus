...
<p align="center">
  <img src="readme_img.png" alt="Pixel art" width="800" height="400">
</p>

Implementation of the string.h library with additions.
In this project I developed my own implementation of the string.h library in the C programming language with some additions. The string.h library is the main C library for string handling.
